---
type: "BigQuery Table"
title: "pntr_dashboard_catg2"
description: "PNTR 중카테고리 침투율"
resource: "bigquery://bq-da-common.cman_data.pntr_dashboard_catg2"
tags: ["tier2", "agg_mart"]
status: "draft"
...
# pntr_dashboard_catg2

- **Project.Dataset.Table**: `bq-da-common.cman_data.pntr_dashboard_catg2`
- **Grain**: 주차 × 대×중 카테고리
- **Partition**: `-` (-)
- **Key columns**: year+weeknum+catg_1_nm+catg_2_nm
- **Used for**: PNTR 중카테고리 침투율
...
| `catg_2_nm` | STRING | - | YES | 중카테고리 | - | [v4 보강 — 환경회복 후 검증 필요] week_before/perc 컬럼명 오타(weeek1_perc 등)는 사내 명명 그대로 유지 |
...
pntr_dashboard_catg1과 동일 산출식

# Joins

- [pntr_dashboard_catg1](./pntr_dashboard_catg1.md)
